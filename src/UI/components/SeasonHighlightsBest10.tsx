...
export function SeasonHighlightsBest10(props: SeasonHighlightsProps) {
      ...
      <div className="flex flex-col w-full sm:flex-row items-center gap-4">
        <div className="flex flex-col w-full p-4 text-white bg-slate-800 rounded-md sm:min-w">
          ...
          <div className="text-md font-bold text-amber-500 mb-2">
            {getPlayerSeasonBest10PointsWithHandicap(props.season, bestSeasonPlayers[0].id)} points
          </div>
        ...
        <div className="flex flex-col w-full p-4 text-white bg-slate-800 rounded-md">
          ...
          <div className="text-md font-bold text-amber-500 mb-2">
            {getPlayerSeasonBest10PointsWithHandicap(props.season, bestSeasonPlayers[1].id)} points
          </div>
          <div className="text-sm">
        ...
        <div className="flex flex-col w-full p-4 text-white bg-slate-800 rounded-md">
          ...
          <div className="text-md font-bold text-amber-500 mb-2">
            {getPlayerSeasonBest10PointsWithHandicap(props.season, bestSeasonPlayers[2].id)} points
          </div>
          <div className="text-sm">
